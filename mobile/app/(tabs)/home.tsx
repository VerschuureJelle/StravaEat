...
const st = StyleSheet.create({
  ...
  cardTitle: { fontSize: 11, fontWeight: '700', color: '#aaa', textTransform: 'uppercase', letterSpacing: 0.7, marginBottom: 0 },

  // Weather
  weatherHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  weatherToggle: { flexDirection: 'row', backgroundColor: '#f0f0f0', borderRadius: 8, padding: 2 },
  weatherToggleBtn: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 6 },
  weatherToggleBtnActive: { backgroundColor: '#fff', shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 3, elevation: 1 },
  weatherToggleText: { fontSize: 12, fontWeight: '600', color: '#888' },
  weatherToggleTextActive: { color: '#111' },

  weatherMain: { flexDirection: 'row', alignItems: 'center', gap: 20, marginBottom: 12 },
  tempBig: { fontSize: 44, fontWeight: '800', color: '#111', lineHeight: 46 },
  ...
  hourlyItem: { alignItems: 'center', minWidth: 52, paddingHorizontal: 6, paddingVertical: 8, backgroundColor: '#f8f8f8', borderRadius: 10, marginRight: 6 },
  hourlyTime: { fontSize: 10, color: '#aaa', fontWeight: '600' },
  hourlyTemp: { fontSize: 13, fontWeight: '700', color: '#333' },
  hourlyRain: { fontSize: 10, color: '#90A4AE', marginTop: 2 },
  hourlyRainHigh: { color: '#1565C0', fontWeight: '700' },
  ...
  weekDay: { fontSize: 14, color: '#555', width: 84 },
  weekDayToday: { fontWeight: '700', color: '#111' },
  weekTemps: { flexDirection: 'row', gap: 6, marginLeft: 'auto' },
  weekTempHigh: { fontSize: 14, fontWeight: '700', color: '#111', width: 32, textAlign: 'right' },
  weekTempLow: { fontSize: 14, color: '#aaa', width: 32, textAlign: 'right' },
  weekRainWrap: { flexDirection: 'row', alignItems: 'center', gap: 3, width: 44, marginLeft: 10 },
  weekRain: { fontSize: 12, color: '#aaa' },
  weekRainHigh: { color: '#1565C0', fontWeight: '700' },
  ...
  appBtn: { flex: 1, borderWidth: 1, borderColor: '#eee', borderRadius: 12, padding: 16, alignItems: 'center', gap: 8, backgroundColor: '#fafafa' },
  appBtnText: { fontSize: 13, fontWeight: '700', color: '#333' },
})

const mo = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'flex-end' },
  sheet: { backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingHorizontal: 24, paddingBottom: 40, paddingTop: 12 },
  ...
  tipBox: { flexDirection: 'row', gap: 8, backgroundColor: '#FFF0EB', borderRadius: 12, padding: 12, marginBottom: 10 },
  tipText: { flex: 1, fontSize: 13, color: '#FC4C02', lineHeight: 19 },
  plannedBox: { flexDirection: 'row', gap: 8, backgroundColor: '#F0F0FF', borderRadius: 12, padding: 12, marginBottom: 20 },
  plannedText: { flex: 1, fontSize: 13, color: '#5C63D8', lineHeight: 19 },
  closeBtn: { backgroundColor: '#111', borderRadius: 12, padding: 15, alignItems: 'center' },
  closeBtnText: { color: '#fff', fontWeight: '700', fontSize: 16 },
})

const pw = StyleSheet.create({
  card: { borderLeftWidth: 4, borderRadius: 10, backgroundColor: '#f8f8f8', padding: 12 },
  ...
  description: { fontSize: 13, color: '#444', lineHeight: 19 },
  aiBadge: { backgroundColor: '#7C83FD22', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
